    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          "arn:aws:bedrock:${local.region}::foundation-model/eu.anthropic.claude-3-5-sonnet-20241022-v2:0",
          "arn:aws:bedrock:*::foundation-model/eu.anthropic.claude-3-5-sonnet-20241022-v2:0"
        ]
      },
      {
...
resource "aws_bedrockagent_agent" "main" {
  ...
  foundation_model            = "eu.anthropic.claude-3-5-sonnet-20241022-v2:0"
